...
root.title('SSIS - Mike Jerald B. Bentilacion')
root.state('zoomed')
...
Frame1 = LabelFrame(root, bg="cadetblue1", highlightbackground="gray26",highlightthickness=4)
Frame1.place(x=8,y=90,height=320,width=1350)

Frame2 = LabelFrame(root, bg="cadetblue1",highlightbackground="gray26",highlightthickness=4)
...
def addstudent():
    ...
    L_ID = Label(win, font=('Apple SD Gothic Neo',13, 'bold'),text="Student ID:(NNNN-YYYY)  ", padx=2, pady=2, bg ="cadetblue1", fg="black")
    L_ID.grid(row=0, column=0, sticky=W)
    E_ID = Entry(win, font=('Apple SD Gothic Neo',13), width=25)
    E_ID.grid(row=0, column=1, pady=8)
    
    L_name = Label(win, font=('Apple SD Gothic Neo',13, 'bold'),text="Name", padx=2, pady=2,  bg ="cadetblue1", fg="black")
    ...
    L_course = Label(win, font=('Apple SD Gothic Neo',13, 'bold'),text="Course", padx=2, pady=2, bg ="cadetblue1", fg="black")
    ...
    L_year = Label(win,text="Year Level ", padx=2, pady=2, font=('Apple SD Gothic Neo',13, 'bold'), bg ="cadetblue1", fg="black")
    ...
    L_gender = Label(win, text="Gender ", padx=2, pady=2, font=('Apple SD Gothic Neo',13, 'bold'), bg ="cadetblue1", fg="black")
...
def editstudent(index):
    ...
    win4.configure(background="cadetblue1")



    student = my_tree.item(index)['values']

    L_ID = Label(win4, font=('Apple SD Gothic Neo',13, 'bold'),text="Student ID:(NNNN-YYYY)  ", padx=2, pady=2, bg ="cadetblue1", fg="black")
    L_ID.grid(row=0, column=0, sticky=W)
    E_ID = Entry(win4, font=('Apple SD Gothic Neo',13), width=25,textvariable= STD_ID)
    E_ID.grid(row=0, column=1, pady=8)
    
    L_name = Label(win4, font=('Apple SD Gothic Neo',13, 'bold'),text="Name", padx=2, pady=2,  bg ="cadetblue1", fg="black")
    L_name.grid(row=1, column=0, sticky=W)
    E_name = Entry(win4, font=('Apple SD Gothic Neo',13), width=25,textvariable= STD_name)
    E_name.grid(row=1, column=1, pady=8)
    
    L_course = Label(win4, font=('Apple SD Gothic Neo',13, 'bold'),text="Course", padx=2, pady=2, bg ="cadetblue1", fg="black")
    L_course.grid(row=2, column=0, sticky=W)
    E_course = Entry(win4, font=('Apple SD Gothic Neo',13), width=25,textvariable= STD_course)
    E_course.grid(row=2, column=1, pady=8)
    
    L_year = Label(win4,text="Year Level ", padx=2, pady=2, font=('Apple SD Gothic Neo',13, 'bold'), bg ="cadetblue1", fg="black")
    L_year.grid(row=3, column=0, sticky=W)
    ...
    L_gender = Label(win4, text="Gender ", padx=2, pady=2, font=('Apple SD Gothic Neo',13, 'bold'), bg ="cadetblue1", fg="black")
    L_gender.grid(row=4, column=0, sticky=W)
...
def add():
    ...
    win1 = Frame(win, bg="cadetblue1")
    win1.grid()



    Lccode = Label(win1, font=('Apple SD Gothic Neo',13, 'bold'),text="Course code  ", padx=2, pady=2, bg ="cadetblue1", fg="black")
    ...
    Lcname = Label(win1, font=('Apple SD Gothic Neo',13, 'bold'),text="Course name", padx=2, pady=2,  bg ="cadetblue1", fg="black")
...
def edit(index):
    ...
    win2.configure(background="cadetblue1")

    select = my_tree1.item(index)['values']

    win3 = Frame(win2, bg="cadetblue1")
    win3.grid()



    Lccode1 = Label(win3, font=('Apple SD Gothic Neo',13, 'bold'),text="Course code  ", padx=2, pady=2, bg ="cadetblue1", fg="black")
    ...
    Lcname1 = Label(win3, font=('Apple SD Gothic Neo',13, 'bold'),text="Course name", padx=2, pady=2,  bg ="cadetblue1", fg="black")
